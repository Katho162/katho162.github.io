    ...
    render() {
        return(
            <section className="languages__section">
                ...
                <Language  languageImage={norwayFlag} languageName="Norsk Bokmål" languageText="Jeg har ikke så mye å snakke som norsk, men jeg trør at det norsk og Norge er så kult, til og med min norsk er ikke god vil jeg forbrede det en dag. Og kan være det skal jeg går til Norge en dag."/>
                ...
                <Language  languageImage={polandFlag} languageName="Polskie" languageText="Zacząłem interesować się polską nie tak dawno temu, ale odkąd zacząłem się o tym dowiedzieć, zauważyłem po prostu, jak fajnie jest polska i polska. fascynuje mnie coraz bardziej, a pewnego dnia chcę dla ciebie płynnie mówić po polsku! (ten tekst został wygenerowany za pomocą automatycznego tłumacza)" disabled/>
