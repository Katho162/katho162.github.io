    ...
    render() {
        return(
            <section className="languages__section">
                <h2>Languages</h2>
                <Language  languageImage={franceFlag} languageLevel="B2" languageName="Français" languageText="Velit in aliquip esse Lorem. Exercitation nostrud eu incididunt eiusmod reprehenderit. Lorem consequat incididunt ad officia ex eiusmod et exercitation."/>
                <Language  languageImage={brazilFlag} languageLevel="C2" languageName="Português" languageText="Sint tempor eiusmod irure non. Eiusmod irure nisi elit incididunt minim nisi. In officia nulla cupidatat commodo mollit minim aliqua qui. In eu est quis mollit nostrud nulla laborum id minim."/>
                <Language  languageImage={germanyFlag} languageLevel="B2" languageName="Deutsch" languageText="Esse dolor eu dolore proident et exercitation non reprehenderit. Nisi qui nisi amet ex commodo laboris. Labore qui ex ex esse sunt. Eu non nisi voluptate deserunt consequat exercitation do ipsum reprehenderit nostrud. Ut duis consequat consequat enim non Lorem nisi exercitation reprehenderit."/>
                <Language  languageImage={russiaFlag} languageLevel="A2" languageName="Русский" languageText="Consequat ut quis cillum aliquip laborum. Enim velit ex ex et nisi cillum officia consectetur proident labore commodo aliquip ipsum. Incididunt id voluptate excepteur nisi enim sunt aliquip minim eu ad."/>
                <Language  languageImage={ukFlag} languageLevel="C1" languageName="English" languageText="Sunt aliquip cillum veniam mollit esse ad minim Lorem nisi et non. Commodo eu laboris in proident nostrud culpa ex elit ex et aute incididunt est commodo. Id proident est enim ea nostrud fugiat. Sit commodo enim exercitation consequat culpa culpa officia in. Non ut et pariatur commodo magna voluptate."/>
                <Language  languageImage={norwayFlag} languageLevel="B1" languageName="Norsk Bokmål" languageText="Mollit minim consectetur sint dolore Lorem est incididunt magna adipisicing. Enim amet laborum ullamco in commodo qui aute laboris nostrud cillum sunt ea sunt. Enim commodo deserunt irure culpa amet nulla fugiat fugiat enim. In nisi ea sit minim aute. Fugiat pariatur adipisicing sint occaecat non esse minim nulla quis excepteur nostrud adipisicing voluptate excepteur. Aliqua amet esse tempor est irure."/>
